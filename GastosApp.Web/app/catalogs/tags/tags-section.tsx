          ...
          <Card className="relative flex h-[100dvh] w-full max-w-none flex-col app-sidebar border-l p-0 sm:h-full sm:max-w-xl" onClick={(event) => event.stopPropagation()}>
            <div className="sticky top-0 z-10 border-b border-strong bg-[color-mix(in_srgb,var(--color-surface-1)_95%,transparent)] px-4 py-3 backdrop-blur sm:px-5 sm:py-4">
              ...
              <div className="flex items-start justify-between gap-3">
                <h3 className="text-lg font-semibold text-primary">{tagForm.id ? "Editar tag" : "Nuevo tag"}</h3>
                <Button type="button" variant="ghost" className="btn-secondary-semantic h-8 rounded-md px-2.5" onClick={() => setTagModalOpen(false)}>
                  Cerrar
                </Button>
              </div>
            </div>
            ...
            <form className="flex h-full flex-col" onSubmit={(event) => void submitTag(event)}>
              ...
              <div className="border-t border-strong bg-[color-mix(in_srgb,var(--color-surface-1)_95%,transparent)] px-4 py-3 sm:px-5 sm:py-4">
                <div className="flex justify-end gap-2">
                  <Button type="button" variant="secondary" className="btn-secondary-semantic h-8 rounded-md px-3 text-xs font-bold" onClick={() => setTagModalOpen(false)}>
                    Cancelar
                  </Button>
