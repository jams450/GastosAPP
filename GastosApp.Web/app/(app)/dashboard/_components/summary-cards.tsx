  ...
  return (
    <DashboardMetricCards
      ...
      items={[
        ...
        { title: "Pendiente MSI", amount: summary.creditDebtMsi, toneClass: "dashboard-money-credit" },
        { title: "Pendiente normal", amount: summary.creditDebtNormal, toneClass: "dashboard-money-credit" }
      ]}
    />
  );
}
